-- order_id 19998: insert, update and delete, separate transactions
...
BEGIN; -- order_id 19999: insert, update, delete. Effectively a no-op as the row ends up deleted
...
UPDATE orders SET shipped_date = DATE '1996-07-17' WHERE order_id = 19999;
