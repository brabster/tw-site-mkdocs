...
In previous posts, I [disambiguated transactions by filtering out any transient statements](../2024-06-04-disambiguating-transactions-in-change-data-capture/index.md) and noted that [changes in primary key values cause big problems](../2024-06-12-breaking-cdc-with-primary-keys/). Now I can start to answer useful questions about the current and historical changes in a source table.
